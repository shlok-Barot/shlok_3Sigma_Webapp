        ...
        <Card className="main_card">
          ...
          <div className="card_footer">
            ...
            <div className="button_section">
              <button onClick={() => onShare()} className="btn btn-default m-2">
              ...
              <button
                onClick={(e) => onContentDelete(e, item?._id)}
                type="submit"
                className="btn delete btn-default m-2"
              >
        ...
        <Card className="main_card">
          ...
          <div className="card_footer">
            ...
            <div className="button_section">
              ...
              <button
                onClick={(e) => onContentDelete(e, page?._id)}
                className="btn delete btn-default m-2"
              >
                <i className="bi bi-trash text-danger"></i>
              </button>
        ...
        <Card className="main_card">
          ...
          <div className="card_footer">
            ...
            <div className="button_section">
              ...
              <button
                onClick={(e) => onContentDelete(e, file?._id)}
                className="btn delete btn-default m-2"
              >
                <i className="bi bi-trash text-danger"></i>
              </button>
