...
const AddEditList: React.FC<PropsWithChildren<Props>> = ({
  ...
  const toggleLeadDistribution = () => {
    setEnableLeadDistribution(!enableLeadDistribution);
  };
          ...
          {weighted && (
            <div className="countincrement">
              <button
                type="button"
                className="count_btn"
                onClick={() => incrementCount(member?._id, index)}
              >
                +
              </button>
              ...
              <button
                type="button"
                className="count_btn"
                onClick={() => decrementCount(member?._id, index)}
              >
                -
              </button>
            </div>
